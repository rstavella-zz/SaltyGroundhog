...
<html>
<head>
 <title>Upload Professional Profile</title>
...
<div id="wrapper">
    <div id="header">
         <center><h1>Upload Professional Image</h1></center>
    </div>
    <div id="content">
        <div class="main">
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        echo "<script type='text/javascript'>alert('$message'); document.location.href = 'uploadProfImage.php?id=$identity';</script>";
