...
Senior Project
True Course Website
This page allows a professional to edit a Family Members Profile
-->
...
<?php
   ...
   if(isset($_GET['id'])){
      $identity=$_GET['id'];
      $query = pg_query("SELECT cu.Cust_ID, cu.First_Name, cu.Last_Name, cu.Street_Address, cu.relation, cu.Zipcode, cu.state, cu.city, cu.country,
