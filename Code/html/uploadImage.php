...
Senior Project
True Course Website
This page allows a professional to upload a client profile photo
-->
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
     ...
     if($result){
                header('Location: customerProfilePage.php?id=' . $identity);
        }else{
         header('Location: uploadImage.php?id=' . $identity);
        }
