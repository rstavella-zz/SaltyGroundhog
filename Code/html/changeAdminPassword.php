...
Senior Project
True Course Website
This page is to change the password of a license manager
-->
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li><a href="adminPage.php"><img src="true.jpg" class="img-rounded" alt="Home" width="70" height="30"> </a></li>
      </ul>
...
<!-- Print Output out new password and confirm password -->
<body>
<div id="wrapper">
   <div id="header">
      ...
      <div class="main">
         <div class="main-section agile">
            <div class="login-form">
		       ...
		       <li> <input type="password" name="newPass" placeholder="New Password"></li><center>
                      <div class="clear"></div>
                   </ul>
                   <ul>
        ...
        if($newPass === $comPass){
           if (!preg_match('/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,16}$/', $newPass)){
            ...
            $newPass = password_hash($newPass, PASSWORD_DEFAULT);
          	$query = pg_query("UPDATE license_managers SET password = '$newPass' WHERE manager_id = '$manager'");
