...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
	...
	<body>
	<!-- This page is to add a new family member to another family member
	     The page is similar to addFamilyMember it is just that this must link differently then on that page
	     Here we are asking for all important information for a family members profile
	-->
                        ...
                        <div class="main">
                                <div class="main-section agile">
                                        <div class="login-form">
                                                <form action="newFamilyFamilyMember.php?id=<?php echo $identity ?>" method="post">
                                                        <ul>
